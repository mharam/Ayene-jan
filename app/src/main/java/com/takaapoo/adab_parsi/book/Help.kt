...
//    val screamColor = bookFragment.requireContext().getColorFromAttr(R.attr.colorHelpScream)
...
//    private val helpScrimDim = bookFragment.resources.getDimension(R.dimen.help_scream_dim)
    ...
    private fun openHelp1(delay: Long){
        binding.root.doOnLayout {
            binding.helpDialog.apply {
                ...
                dismiss.setOnClickListener{ bookViewModel.doneShowHelp() }
                next.setOnClickListener { bookViewModel.increaseShowHelp() }
                c1.isActivated = true
            }
        }
        ...
        bookFragment.currentChildFragment?.binding?.bookToolbar?.doOnPreDraw {
            ...
            binding.helpDialog.root.doOnLayout {
                binding.helpDialog.apply {
                    ...
                    next.setOnClickListener { bookViewModel.doneShowHelp() }
                    c1.isActivated = true
                    c2.isActivated = true
                }
            }
